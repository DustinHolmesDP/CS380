...
Color Terrain::seekSearchColor = Colors::Salmon;
...
void Terrain::shutdown()
{
    ...
    wallLayer.free_memory();
    pathLayer.free_memory();
    opennessLayer.free_memory();
    totalVisibilityLayer.free_memory();
    cellVisibilityLayer.free_memory();
    occupancyLayer.free_memory();
    agentVisionLayer.free_memory();
    fogLayer.free_memory();
    seekLayer.free_memory();
}
