...
BehaviorAgent::BehaviorAgent(const char *type, size_t id) : Agent(type, id), speed(10.0f)
{
...
float BehaviorAgent::get_movement_speed() const
{
    return speed;
}

void BehaviorAgent::set_movement_speed(float newSpeed)
{
    speed = newSpeed;
}
